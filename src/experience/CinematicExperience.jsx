 ...
 * the primary volumetric lighting system (Phase 1B, approved), and the
 * scroll-driven camera (Phase 1C). No Phase 1D cinema-camera/monitor
 * meshes, portfolio content, audio, or post-processing belong here yet.
 *
